            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('howitworks') }}">{{ __('HOW IT WORKS') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('rates') }}">{{ __('RATES') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('trackyourshipment') }}">{{ __('TRACKYOURSHIPMENT') }}</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link login" id="nav-login" href="{{ route('login') }}">{{ __('LOG IN') }}</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link create" id="nav-login" href="{{ route('register') }}">{{ __('CREATE AN ACCOUNT') }}</a>
                                </li>
                            @endif
                        @else
